...
mod tests {
    ...
    #[tokio::test]
    async fn test_registered_bot_event_handler_does_not_hold_client_strong_reference() {
        ...
        let handler = BotEventHandler {
            ...
            event_handler: bot.event_handler.take(),
        };
        client.core.event_bus.add_handler(Arc::new(handler));

        assert_eq!(Arc::strong_count(&client), before);
