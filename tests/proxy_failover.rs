...
async fn failover_on_non_200_until_success() {
    ...
    storage::create_channel(
        ...
        storage::CreateChannel {
            ...
            base_url: None,
            base_urls: Some(vec![format!("{base1}/v1")]),
            auth_type: None,
            auth_ref: None,
            auth_refs: Some(vec!["t1".to_string()]),
            priority: 30,
    ...
    storage::create_channel(
        ...
        storage::CreateChannel {
            ...
            protocol: storage::Protocol::Openai,
            base_url: None,
            base_urls: Some(vec![format!("{base2}/v1")]),
            auth_type: None,
            auth_ref: None,
            auth_refs: Some(vec!["t2".to_string()]),
            priority: 20,
            recharge_currency: None,
            real_multiplier: None,
            enabled: true,
    ...
    storage::create_channel(
        ...
        storage::CreateChannel {
            ...
            protocol: storage::Protocol::Openai,
            base_url: None,
            base_urls: Some(vec![format!("{base3}/v1")]),
            auth_type: None,
            auth_ref: None,
            auth_refs: Some(vec!["t3".to_string()]),
            priority: 10,
            recharge_currency: None,
            real_multiplier: None,
            enabled: true,
    ...
    for (name, base, priority) in [("c1", base1, 30), ("c2", base2, 20), ("c3", base3, 10)] {
        storage::create_channel(
            ...
            storage::CreateChannel {
                ...
                protocol: storage::Protocol::Openai,
                base_url: None,
                base_urls: Some(vec![format!("{base}/v1")]),
                auth_type: None,
                auth_ref: None,
                auth_refs: Some(vec!["t".to_string()]),
                priority,
                recharge_currency: None,
                real_multiplier: None,
                enabled: true,
...
async fn gemini_logs_include_model_and_cost() {
    ...
    storage::create_channel(
        ...
        storage::CreateChannel {
            ...
            base_url: None,
            base_urls: Some(vec![format!("{base}/v1beta")]),
            auth_type: None,
            auth_ref: None,
            auth_refs: Some(vec!["t".to_string()]),
            priority: 10,
